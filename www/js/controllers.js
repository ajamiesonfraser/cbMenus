...
.controller('restaurantsCtrl', function($scope) {
  $scope.restaurants = [
    ...
    .controller('restaurantCtrl', function($scope, $stateParams) {
      $scope.restaurants = [
        { title: "Amedeo's Italian Bistro", id: 1, description: "oineroirnvreoinveroinver'oneroneroivenreinev"},
        { title: 'Black Diamond Bar & Grill', id: 2, description: "kkkkkkkkkkkkkkkkkkkkkkkk"},
        { title: 'Bonnie Prince', id: 3,},
        { title: 'Casino Nova Scotia', id: 4 },
        { title: 'Crown & Moose Pub', id: 5 },
        { title: "Daniel's Pub", id: 6 },
        ...
        { title: 'Embers Southern Barbeque', id: 9 },
        { title: 'Flavor 19', id: 10 },
        { title: 'Flavor Downtown', id: 11, img: src="http://cbflavor.com/downtown/wp-content/uploads/2011/11/Flavor_Downtown_Menu.jpg" },
        { title: 'Flavor on the Water', id: 12 },
        { title: 'Fortune Star Chinese Restaurant', id: 13 },
        { title: "Fuzzy's Fries", id: 14 },
        { title: 'Governors Pub & Eatery', id: 15 },
